...
namespace Tonny.Common.Utility
{
    public class PlayerPrefsX
    {
        ...
        {
            //Make a byte array that's a multiple of 8 in length,plus 5 bytes to store
            //the number of entries as an int32(+ identifier),we have to store the number
            //of entries,since the boolArray length might not be a multiple of 8,so there
            //could be some padded zeroes
